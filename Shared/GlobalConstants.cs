...
namespace Shared
{
    public static class GlobalConstants
    {
        ...
        public const string AudioRecordingsFolderLinux = @"$HOME/audioRecordings";
        public const string VideoRecordingsFolderLinux = @"@HOME/videos";
        public const string AudioServiceFolderLinux = @"$HOME/budorBeach/AudioService";
        public const string BirdNetAnalyzerPathLinux = @"$HOME/BirdNET-Analyzer";
